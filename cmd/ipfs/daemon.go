...
import (
	...
	utilmain "paidpiper/ipfs/go-ipfs/cmd/ipfs/util"
	oldcmds "paidpiper/ipfs/go-ipfs/commands"
	"paidpiper/ipfs/go-ipfs/core"
	commands "paidpiper/ipfs/go-ipfs/core/commands"
	coreapi "paidpiper/ipfs/go-ipfs/core/coreapi"
	corehttp "paidpiper/ipfs/go-ipfs/core/corehttp"
	corerepo "paidpiper/ipfs/go-ipfs/core/corerepo"
	libp2p "paidpiper/ipfs/go-ipfs/core/node/libp2p"
	nodeMount "paidpiper/ipfs/go-ipfs/fuse/node"
	fsrepo "paidpiper/ipfs/go-ipfs/repo/fsrepo"
	migrate "paidpiper/ipfs/go-ipfs/repo/fsrepo/migrations"
...
func daemonFunc(req *cmds.Request, re cmds.ResponseEmitter, env cmds.Environment) (_err error) {
	...
	if initialize && !fsrepo.IsInitialized(cctx.ConfigRoot) {
		...
		if err = doInit(os.Stdout, cctx.ConfigRoot, false, nBitsForKeypairDefault, profiles, nil, nil, conf); err != nil {
			return err
		}
	}
